...
void instruction_execute(int instruction)
{
	...
	case 0b0100011:
		switch (funct3)
		{
			//SB
		case 0b000:
			*(mem + i_reg[rs1] + s_imm) = LOW_8(i_reg[rs2]);
			break;
			//SH
		case 0b001:
			*((short *)(mem + i_reg[rs1] + s_imm)) = LOW_16(i_reg[rs2]);
			break;
			//SW
		case 0b010:
			*((int *)(mem + i_reg[rs1] + s_imm)) = LOW_32(i_reg[rs2]);
			break;
			//SD
		case 0b011:
			*((long long *)(mem + i_reg[rs1] + s_imm)) = i_reg[rs2];
			break;
		}
		break;
	...
	case 0b0000111:
		switch (funct3)
		{
			//FLW
		case 0b010:
			d_reg[rd] = FMEM(i_imm + i_reg[rs1]);
			break;
			//FLD
		case 0b011:
			d_reg[rd] = DMEM(i_imm + i_reg[rs1]);
			break;
		}
		break;
